...
struct Vec3 {
    ...
    explicit Vec3<T>(content3 newContent)
    ...
    inline Vec3<T> operator-() const {
        return Vec3{m_content * -1};
    }

    inline Vec3<T> operator+(const Vec3<T>& second) const {
        return Vec3{m_content + second.m_content};
    }
    ...
    inline Vec3<T> operator*(const T k) const {
        return Vec3{m_content * k};
    }

    inline Vec3<T> operator/(T k) const {
        return Vec3{m_content / k};
    }

    inline Vec3<T>& operator+=(const Vec3<T>& second) {
