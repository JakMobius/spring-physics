...
class GpuWindow {
  ...
  public:
    ...
    int get_graphics_queue_family() const {
        return m_graphics_queue_family;
    }
    int get_present_queue_family() const {
        return m_present_queue_family;
    }

    VK::Queue get_device_graphics_queue() const {
        return m_device_graphics_queue;
    }
    VK::Queue get_device_present_queue() const {
        return m_device_present_queue;
    }
