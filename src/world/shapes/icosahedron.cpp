...
const std::vector<Vec3f> IcosahedronShape::vertices{
    {-1, 0, golden_ratio}, {1, 0, golden_ratio}, {-1, 0, -golden_ratio}, {1, 0, -golden_ratio}, {0, golden_ratio, 1}, {0, golden_ratio, -1}, {0, -golden_ratio, 1}, {0, -golden_ratio, -1}, {golden_ratio, 1, 0}, {-golden_ratio, 1, 0}, {golden_ratio, -1, 0}, {-golden_ratio, -1, 0}};
