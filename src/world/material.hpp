...
public:
  ...
  Vec3f get_color() { return m_color; }
  void set_color(const Vec3f& color);

  bool get_grid() { return m_grid; }
  void set_grid(bool value);

  int get_buffer_index() { return m_buffer_index; }
  void set_buffer_index(int index) { m_buffer_index = index; }

  float get_specular_factor() { return m_specular_factor; }
